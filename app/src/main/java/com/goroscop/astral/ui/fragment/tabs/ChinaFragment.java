...
public class ChinaFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        txtChina = view.findViewById(R.id.txt_china);
        txtChinaAll = view.findViewById(R.id.txt_china_all);
    ...
    private void initInfo() {
        ...
        avatar.setImageResource(avatarChinaIcon.get(getChinaSign(mSettings.getString(APP_PREFERENCES_BIRTHDAY, ""))));
